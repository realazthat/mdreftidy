...
Turn this ([./examples/SIMPLE.md](https://github.com/realazthat/mdreftidy/blob/v0.6.1/examples/SIMPLE.md)):
...
Into this ([./examples/SIMPLE.tidied.md](https://github.com/realazthat/mdreftidy/blob/v0.6.1/examples/SIMPLE.tidied.md)):
...
Example README: ([./examples/SIMPLE.md](https://github.com/realazthat/mdreftidy/blob/v0.6.1/examples/SIMPLE.md)):
...
- Example:
  - Original: [./examples/SIMPLE.md](https://github.com/realazthat/mdreftidy/blob/v0.6.1/examples/SIMPLE.md).
  - Tidied: [./examples/SIMPLE.tidied.md](https://github.com/realazthat/mdreftidy/blob/v0.6.1/examples/SIMPLE.tidied.md).
  - Generation script: [./examples/simple_example.sh](https://github.com/realazthat/mdreftidy/blob/v0.6.1/examples/simple_example.sh).
